...
export const CATEGORIES: CategoryDef[] = [
  {
    ...
    units: [
      ...
      { id: 'overlay-cancel', name: '重ね図形', icon: '🔲', implemented: true, group: '重ね図形', subLabel: '相殺' },
      { id: 'overlay-cancel-3x3', name: '重ね図形', icon: '🔲', implemented: true, group: '重ね図形', subLabel: '相殺 3×3' },
      { id: 'overlay-cancel-4x4', name: '重ね図形', icon: '🔲', implemented: true, group: '重ね図形', subLabel: '相殺 4×4' },
      { id: 'overlay-compose', name: '重ね図形', icon: '🔲', implemented: true, group: '重ね図形', subLabel: '合成' },
